...
AMW: Installs cleanly from git. I fixed a couple missing imports. You probably want to re-run devtools::document() to make sure those are in the DESCRIPTION correctly.
