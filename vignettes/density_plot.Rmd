...
```{r, fig.cap="A density plot comparing the distribution of 'Posterior' and 'Likelihood' values from the log_1 dataset."}
LanguirandR::density_plot(log_1, "Posterior", "Likelihood", "plot title", "Posterior", "Density")
```
